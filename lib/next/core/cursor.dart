...
class CursorStyle {
  ...
  void setForegroundColor16(int color) {
    this.foreground = color | CellColor.named;
  }

  void setForegroundColor256(int color) {
    this.foreground = color | CellColor.palette;
  }
  ...
  void setBackgroundColor16(int color) {
    this.background = color | CellColor.named;
  }

  void setBackgroundColor256(int color) {
    this.background = color | CellColor.palette;
  }
